...
#Parametros
epocas = 10
alto, largo = 100, 100      #dimensiones de las imagenes. Para redimenzionar
batch_size = 3      #numero de imagenes que se mandara a procesar por cada paso (mayor de 2)
pasos = 25      #pasos: 25
pasos_validacion = 10   #pasos de validacion: 10
...
clases = 1 #total de clases a clasificar
