...
def predict(file):
    ...
    match respuesta:
        case 0:
            return 'P1_IgdaliasQuijano'
        case 1:
            return 'P2_ItzelArteaga'
        case 2:
            return 'P3_CarlosAvila'
        case _:
            return '----'
...
def probar_red_neuronal():
    ...
    for folder in folders:
        files = [archivo for archivo in os.listdir(base_location + '/' + folder) if
                 archivo.endswith(".jpg") or archivo.endswith(".jpeg") or archivo.endswith(".png")]
        for file in files:
